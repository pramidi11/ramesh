...
public class Runner {
    ...
    public void setup() {
     ...
     public boolean openPieFace(String payload, boolean submit) throws IOException {
    ...
    public void logBookEntries() throws Exception {
        setup();
        ...
        taskList.forEach(task -> {
            try {
                task.setSuccess(openPieFace(new ObjectMapper().writeValueAsString(task), false));
